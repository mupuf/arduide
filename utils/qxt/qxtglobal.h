...
#define QXT_CORE_EXPORT IDE_EXPORT
#define QXT_GUI_EXPORT IDE_EXPORT
#define QXT_NETWORK_EXPORT IDE_EXPORT
#define QXT_SQL_EXPORT IDE_EXPORT
#define QXT_WEB_EXPORT IDE_EXPORT
#define QXT_BERKELEY_EXPORT IDE_EXPORT
#define QXT_ZEROCONF_EXPORT IDE_EXPORT
